...
class aerial_shot():
    # Very similar to jump_shot(), but instead designed to hit targets above 300uu ***This routine is a WIP*** It
    # does not currently hit the ball very hard, nor does it like to be accurate above 600uu or so
